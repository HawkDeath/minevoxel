...
SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device,
  ...
  vkGetPhysicalDeviceSurfaceFormatsKHR(device, *surface, &countFormats,
                                       nullptr);
  ...
  vkGetPhysicalDeviceSurfacePresentModesKHR(device, *surface,
                                            &countPresentsMode, nullptr);

  if (countPresentsMode != 0) {
    details.presentModes.resize(countPresentsMode);
    vkGetPhysicalDeviceSurfacePresentModesKHR(
        device, *surface, &countPresentsMode, details.presentModes.data());
  }
...
QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device,
  ...
  vkGetPhysicalDeviceQueueFamilyProperties(device, &countFamilyQueue,
                                           queueFamilies.data());
